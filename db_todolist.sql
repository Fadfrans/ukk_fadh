...
CREATE TABLE `tasks` (
  ...
  `status_task` enum('Finish','Unfinished','','') NOT NULL,
...
(35, 'Membaca Buku sambil makan', 'Finish', 'High Priority', '2025-02-03'),
(36, 'Ngangon Sapi punya krisna', 'Unfinished', 'Medium Priority', '2025-01-31'),
